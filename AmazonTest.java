...
public class AmazonTest {
	...
	public void test() {
		...
		//Sign In Username
		driver.findElement(By.xpath("//*[@id=\'ap_email\']")).sendKeys("moreamruta8518@gmail.com");
		//driver.findElement(By.id("ap_email")).sendKeys("moreamruta8518@gmail.com");
		driver.findElement(By.id("continue")).click();
		
		//Sign In Pass
		driver.findElement(By.xpath("//*[@id='ap_password']")).sendKeys("more@amruta");
