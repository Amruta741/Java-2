...
public class TestHotelApp1 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("username")).sendKeys("amruta0112");
		driver.findElement(By.id("password")).sendKeys("5RLJQ1");
		driver.findElement(By.id("login")).click();
		
		//Search hotel
		Select loc1=new Select(driver.findElement(By.id("location")));
		loc1.selectByIndex(0);
		loc1.selectByVisibleText("Paris");
		...
		//Book Hotel
		driver.findElement(By.id("first_name")).sendKeys("Amruta");
		driver.findElement(By.id("last_name")).sendKeys("More");
		driver.findElement(By.id("address")).sendKeys("Vijaynagar, Sangli.");
